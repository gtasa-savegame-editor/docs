            ...
            <div>
                <div className="section">
                    <table>
                        ...
                        <tr>
                            <td className="type" rowSpan="2">0</td>
                        ...
                        <tr>
                            <td className="type" rowSpan="9">1</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="4">2</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="4">3</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="4">4</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            ...
                            <td>Tec-9</td>
                            <td className="center">Yes</td>
                            <td className="center middle" rowSpan="2">012C</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td className="type" rowSpan="3">5</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="3">6</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="5">7</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="5">8</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="4">9</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="7">10</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="4">11</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
                        ...
                        <tr>
                            <td className="type" rowSpan="2">12</td>
                            <td className="right">00</td>
                            <td>No</td>
                            <td/>
                            <td/>
