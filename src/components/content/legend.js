...
class Legend extends Component {
    render() {
        return (
            <div className="legend" style={{display: (this.props.visible) ? 'block' : 'none'}}>
                <table>
                    <tbody>
                        <tr><td className="header center">Type</td><td className="header">Notes</td><td onClick={this.props.closeLegend} style={{cursor: 'pointer'}}>x</td></tr>
