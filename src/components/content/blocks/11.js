            ...
            <div>
                <div className="section">
                    <table>
                        ...
                        </td><td className="int" colSpan={4}>Weapon id 1</td>
                            <td className="int" colSpan={4}>Weapon id 2</td>
                            <td className="int" colSpan={4}>Weapon id 3</td>
                    ...
                    <ul>
                        <li>Look for the weapon ids at the page <a href="?page=weapons">weapons</a>.</li>
                    </ul>
                </div>
