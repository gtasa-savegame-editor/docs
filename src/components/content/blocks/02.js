      ...
      <div>
        <div>
          <div className="section">
            <p>
              The clothes that you are wearing are somewhere in the grey bytes
              in the middle.
            </p>
            <table>
              <tbody>
            ...
            <ul>
              <li>
                <b>Health</b> is usually at most{' '}
                <code>maximum_health / 5.69</code>, but you can set it to higher
                values.
                <br />
                32767 is the highest value that you can use without letting the
                health bar blink.
              </li>
              <li>
                The <b>Armor</b> bar is full at 100, but when you completed the
                vigilant missions it is full at 150.
                <br />
                You can set this to infinity.
              </li>
              <li>
                <b>S</b> is the weapons start slot. You should read from the
                second S.
              </li>
              <li>
                <b>H</b> is the heaven. (
