            ...
            <div>
                <div>
                    <div className="section">
                        <h2>Missions</h2>
                        <p>
                            The bytes in the following table indicate what mission you are going to do.<br />
                        ...
                        <ul>
                            <li>After the mission "Farewell, my love...", 07B4 goes to 0A.</li>
                            <li>
                                <b>Target</b> is the <b>address</b> of the blip link (see block 9) to the blip on the radar.<br />
                                This is for deleting the radar blib after the mission is completed.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                The first mission has location 14662A44 3C65EFC3 E63F7541 and has a question mark as symbol.<br />
                                In 01.0104, the number of completed missions is saved.<br />
                                This number also increases when completed the mission Wu Zi Mu.
                            </li>
                            <li>
                                After the phone call that enables the Doberman mission, 150C is set to true.
                            </li>
                        </ul>
                    </div>
                    <div className="section">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td className="int">F</td><td className="unknown" /><td className="unknown" /><td className="unknown">
                            ...
                            </td><td className="string" colSpan={8}>Name</td>
                            ...
                            <tr>
                                ...
                                <td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown">01</td><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown">
                            </td><td className="int" colSpan={4}>Activate time</td>
                                <td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                            ...
                            <tr>
                                ...
                                <td className="unknown" /><td className="unknown">
                            </td><td className="int" colSpan={4}>Code</td>
                                <td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                            </td><td className="unknown" /><td className="unknown" /><td className="unknown" /><td className="unknown">
                        ...
                        <ul>
                            <li>The struct gets active on <b>Activate Time</b>. Make sure it is less than the global timer. 0 works fine.</li>
                            <li>Look for the values of <b>F</b>, <b>Name</b> and <b>Code</b> in the <a href="?page=threads">thread table</a>.</li>
                        </ul>
                    </div>
                    <div className="section">
                        <h2>Schools</h2>
                        <table>
                            ...
                            <tr>
                                ...
                                <td rowSpan={12} className="type">Driving</td>
                                <td>The 360</td>
                                <td className="center">%</td>
                            ...
                            <tr>
                                ...
                                <td rowSpan={10} className="type">Flying</td>
                                <td>Takeoff</td>
                                <td className="center">%</td>
                                <td className="right">0</td>
                                <td className="right">&gt; 69</td>
                            ...
                            <tr>
                                ...
                                <td rowSpan={5} className="type">Boat</td>
                            ...
                            <tr>
                                ...
                                <td rowSpan={6} className="type">Bike</td>
                                <td>The 360</td>
                                <td className="center">%</td>
                                <td className="right">0</td>
                                <td className="right">&gt; 69</td>
                        ...
                        <table>
                            <tbody><tr><td className="header">Position</td><td className="header center">School</td><td className="header">Size</td><td className="header">Describtion</td></tr>
                            <tr>
                                <td className="int middle">00D8</td>
                                <td rowSpan={2} className="type">Driving</td>
                                <td className="center middle">4</td>
                                <td>Exercise available (0 - 16)<br />The value is 0 if you never have visited the driving school.</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td rowSpan={4} className="type">Flying</td>
                            ...
                            <tr>
                                <td className="bool">1EA0<br />1EA4</td>
                                <td className="center">1</td>
                                <td>Flying school completed (not sure)</td>
                            </tr>
                            <tr>
                                <td className="int">1EAC</td>
                                <td rowSpan={2} className="type">Boat</td>
                                <td className="center">4</td>
                            ...
                            <tr>
                                ...
                                <td className="center middle">4</td>
                                <td>Exercise available (0 - 6)<br />There is no difference between the values 0 and 1.</td>
                            </tr>
                            </tbody></table>
                        <ul>
                            <li>
                                Some exercises have two numbers, because you can do them clockwise and counter clockwise.<br />
                                If an exercise has two numbers, use both for detecting, but use the highest for saving.
                            </li>
                            <li>
                                The user chooses what exercises are available.<br />
                                The last exercise available and the exercises following must be 0 and disabled for editing.<br />
                                The exception is when the last exercise is selected, then the user can edit everything.
                            </li>
                            <li>If a user sets a percentage value to less than 70, set it to 0.</li>
                            <li>
                                Driving School:
                                <ul>
                                    <li>
                                        If 00D8 equals 0, set every exercise to 0 and don't let the user change anything.<br />
                                        This is because GTA sets 00D8 to 1 when you walk into the red marker.
                                    </li>
                                    <li>
                                        If 015C is false, suggest the user to keep the last exercise at 0.<br />
                            ...
                            <li>
                                Flying School:
                                <ul>
                                    <li>If 0948 is less than 5, the last exercise must be 0, otherwise you can't complete the mission Learning to Fly.</li>
                                    <li>Set the displayed exercise to the same as the available exercises, to make it easy.</li>
                                    <li>It is possible to change the values before the flying mission is available.</li>
                                    <li><a href="http://www.gtasanandreas.net/schools/flight.php">More about the flying school here</a></li>
                                </ul>
                            </li>
                            <li>
                                Boat School:
                                <ul>
                                    <li>If the boat school isn't completed, suggest the user to don't change the value of the last exercise.</li>
                                    <li>It is possible to change the values before the boat school is available.</li>
                                </ul>
                            </li>
                            <li>
                                Bike School:
                                <ul>
                                    <li>It is possible to change the values before the bike school is available.</li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div className="section">
                        <h2>Other</h2>
                        <table>
                            <tbody><tr><td className="header">Position</td><td className="header">Size</td><td className="header">Describtion</td></tr>
                            <tr><td className="bool">00A0</td><td className="center">1</td><td>Position outside</td></tr>
                            <tr><td className="bool">0158</td><td className="center">1</td><td>Help car</td></tr>
                            <tr><td className="bool">01E0</td><td className="center">1</td><td>Help wasted</td></tr>
                            <tr><td className="bool">01FC</td><td className="center">1</td><td>Help busted</td></tr>
                            <tr><td className="int">03E4</td><td className="center">1</td><td>Help swimming (0 - 7)</td></tr>
                            <tr><td className="int">0C88</td><td className="center">4</td><td>Number of <a href="?page=block20">tags</a> sprayed</td></tr>
                            <tr><td className="int">0DD0</td><td className="center">4</td><td>Position house (<a href="?page=savehouses">savehouses</a>)</td></tr>
                            <tr><td className="bool">1310</td><td className="center">1</td><td>Hot Coffee disabled</td></tr>
                            <tr><td className="bool">1514</td><td className="center">1</td><td>Help gym</td></tr>
                            <tr><td className="bool">27D8</td><td className="center">1</td><td>Clothing Shop: Binco</td></tr>
                            <tr><td className="bool">27DC</td><td className="center">1</td><td>Clothing Shop: Pro-Laps</td></tr>
                            <tr><td className="bool">27E0</td><td className="center">1</td><td>Clothing Shop: Sub Urban</td></tr>
                            <tr><td className="bool">27E4</td><td className="center">1</td><td>Clothing Shop: Zip</td></tr>
                            <tr><td className="bool">27E8</td><td className="center">1</td><td>Clothing Shop: Victim</td></tr>
                            <tr><td className="bool">27EC</td><td className="center">1</td><td>Clothing Shop: Didier Sachs</td></tr>
                            <tr><td className="bool">27F0</td><td className="center">1</td><td>Special Clothes: Gimp Suit</td></tr>
                            <tr><td className="bool">27F4</td><td className="center">1</td><td>Special Clothes: Valet Uniform</td></tr>
                            <tr><td className="bool">27F8</td><td className="center">1</td><td>Special Clothes: Croupier</td></tr>
                            <tr><td className="bool">27FC</td><td className="center">1</td><td>Special Clothes: Cop</td></tr>
                            <tr><td className="bool">2800</td><td className="center">1</td><td>Special Clothes: Rural Clothes</td></tr>
                            <tr><td className="bool">2804</td><td className="center">1</td><td>Special Clothes: Racing Suit</td></tr>
                            <tr><td className="bool">2808</td><td className="center">1</td><td>Special Clothes: Medic Uniform</td></tr>
                            <tr><td className="bool">280C</td><td className="center">1</td><td>Special Clothes: Pimp Suit</td></tr>
                            </tbody></table>
                    </div>
                </div>
