                ...
                <div className="section">
                    <table>
                        ...
                        <tr>
                            ...
                            <td className="int" colSpan={4}>209</td>
                            <td className="struct middle" style={{borderLeft: 'none'}} colSpan={28} rowSpan={2}>209 objects of 32 bytes</td>
                        </tr>
                        <tr>
                            <td className="posleft">.</td>
                            <td className="struct" style={{borderRight: 'none'}} colSpan={4} rowSpan={2}>
                            </td></tr>
                        <tr>
                            <td className="posleft">1A20</td>
