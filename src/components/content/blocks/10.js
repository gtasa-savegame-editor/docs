      ...
      <div>
        <div>
          <div className="section">
            There are 378 different zones.
            <br />
            Because the zone <b>MONINT</b> consists of two rectangles, there are
            379 instead of 378 structs A.
            <br />
          ...
          <div className="section">
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="unknown" />
                  <td className="unknown" />
                  <td className="struct" colSpan={22}>
                    379 structs A
                  </td>
                </tr>
                <tr>
            ...
            <ul>
              <li>
                <b>Z</b> is a zone. It is true when it is discovered.
                <br />
                The first zone is at the north west, the second zone is below
                it.
              </li>
              <li>
                <b>Zones</b> is the number of zones discovered.
              </li>
            </ul>
          </div>
          <div className="section">
            <h2>Struct B</h2>
            <p>
              Struct B contains information about an area.
              <br />
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td className="posleft">0000</td>
                  <td className="int">G0</td>
                  <td className="int">G1</td>
                  <td className="int">G2</td>
                  <td className="int">G3</td>
                  <td className="int">G4</td>
                  <td className="int">G5</td>
                  <td className="int">G6</td>
                  <td className="int">G7</td>
                  <td className="int">G8</td>
                  <td className="int">G9</td>
                  <td className="int">D</td>
                  <td className="int" colSpan={4}>
                    Color
                  </td>
            ...
            <ul>
              <li>
                The <b>G</b>s in the table indicate the gang density of a gang.
                <br />
                It is usually between 0 and 40, but higher values are possible.
                <br />
                <table>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>Ballas</td>
                      <td>
                        <span style={{ backgroundColor: '#C800C8' }}>
                          C800C8
                        </span>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>Grove Street</td>
                      <td>
                        <span style={{ backgroundColor: '#46C800' }}>
                          46C800
                        </span>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>Los Santos Vagos</td>
                      <td>
                        <span style={{ backgroundColor: '#FFC800' }}>
                          FFC800
                        </span>
                      </td>
                    </tr>
              ...
              <li>
                <b>Po</b> is the popcycle group, indicating what peds walk
                around and what vehicles drive around:
                <br />
                <table>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>Residential rich secluded</td>
                    </tr>
                    <tr>
