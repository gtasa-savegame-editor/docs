            ...
            <div>
                <div className="section">
                    <table>
                        ...
                        </td><td className="bool">C</td><td className="bool">C</td><td className="bool">C</td><td className="bool">C</td>
                            <td className="bool">C</td><td className="bool">C</td><td className="bool">C</td><td className="bool">C</td>
                            <td className="bool">C</td><td className="bool">C</td><td className="bool">C</td><td className="bool">C</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="bool">C</td><td className="bool">C</td><td className="bool">C</td><td className="bool">C</td>
                            <td className="bool">C</td><td className="bool">C</td><td className="bool">C</td><td className="bool">C</td>
                            <td className="bool">C</td><td className="bool">C</td><td className="bool">C</td>
                    ...
                    <ul>
                        <li><b>C</b> is true if you purchased a clothing item.</li>
                        <li>See <a href="?page=block01">Block 01</a> for special clothes and clothing shops.</li>
                    </ul>
                </div>
