                ...
                <div className="section">
                    <table>
                        ...
                        <tr>
                            ...
                            <td className="int" colSpan={4}>88</td>
                            <td className="bool">Ga</td>
                    ...
                    <ul>
                        <li><b>88</b> is the number of bytes that follows, it's constant.</li>
                        <li>When <b>Ga</b> is true, gang wars are enabled.</li>
                    </ul>
                </div>
