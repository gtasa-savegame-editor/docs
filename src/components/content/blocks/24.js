                    ...
                    <div className="section">
                        <table>
                            ...
                            <tr>
                                ...
                                <td className="int" colSpan={4}>70</td>
                                <td className="struct" colSpan={28}>70 unique jump structs</td>
                            </tr>
                            </tbody></table>
                    </div>
                    <div className="section">
                        ...
                        <table>
                            ...
                            <tr>
                                <td className="posleft">0000</td>
                                <td className="float" colSpan={4}>Start X</td><td className="float" colSpan={4}>Start Y</td><td className="float" colSpan={4}>Start Z</td>
                                <td className="float" colSpan={4}>Start X</td><td className="float" colSpan={4}>Start Y</td><td className="float" colSpan={4}>Start Z</td>
                                <td className="float" colSpan={4}>Land X</td><td className="float" colSpan={4}>Land Y</td>
                            </tr>
                            <tr>
                                <td className="posleft">0020</td>
                                <td className="float" colSpan={4}>Land Z</td>
                                <td className="float" colSpan={4}>Land X</td><td className="float" colSpan={4}>Land Y</td><td className="float" colSpan={4}>Land Z</td>
                                <td className="float" colSpan={4}>Camera X</td><td className="float" colSpan={4}>Camera Y</td><td className="float" colSpan={4}>Camera Z</td>
                                <td className="int" colSpan={4}>$500</td>
                            </tr>
                            <tr>
                                <td className="posleft">0040</td>
                                <td className="bool">C</td><td className="bool">F</td>
                        ...
                        <ul>
                            <li><b>C</b> means completed.</li>
                            <li><b>F</b> means found.</li>
                            <li>The number of unique jumps found and done is saved in block 16</li>
                        </ul>
                    </div>
                </div>
