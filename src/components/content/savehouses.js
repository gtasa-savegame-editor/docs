        ...
        return (
            <div>
                <div className="section">
                    <p>
                        This table shows all the variables relating to your location.<br/>
                        This variables are also in the block documentation pages.<br/>
                        If you save a game outside, block 25 will be two bytes smaller and block 27 two bytes larger.
                    </p>
                    <table>
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            <td className="type" rowSpan="6"><a href="?page=block00">00</a></td>
                            <td className="float">0070</td>
                            <td className="center">4</td>
                            <td className="center">X</td>
                            <td className="middle" rowSpan="3">Camera position</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td className="type" rowSpan="2"><a href="?page=block01">01</a></td>
                        ...
                        <tr>
                            <td className="type" rowSpan="2"><a href="?page=block02">02</a></td>
                        ...
                        <tr>
                            <td className="type" rowSpan="3"><a href="?page=block25">25</a></td>
                        ...
                        <tr>
                            ...
                            <td>These bytes don't exist if saved outside.<br/>Use to detect location, second step if
                                saved inside.
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td className="center middle">Location</td>
                            <td>
                                The address is in the teleport column of the savehouse table.<br/>
                                If the cell is empty, don't set these bytes.
                            </td>
                        </tr>
                        <tr>
                            <td className="type"><a href="?page=block27">27</a></td>
                            <td className="int middle">008C</td>
                            <td className="center middle">2</td>
                            <td className="center middle">0</td>
                            <td className="middle">These bytes don't exist if saved inside.</td>
                        </tr>
                        </tbody>
                    </table>
                    <ul>
                        <li>
                            <b>Location</b> is the <a href="?page=locations">location</a> after leaving the house.<br/>
                ...
                <div className="section">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td className="right">0</td>
                            <td rowSpan="5" className="middle center">Outside</td>
                            <td className="center"></td>
                            <td className="right">1</td>
                    ...
                    <ul>
                        <li>
                            <b>Location inside</b> is the location at the other side of the door
                            of <b>Location</b>.<br/>
                            This information is important, because in the case a house is used for more than one save
                            place,
                            you have to change the teleport.<br/>
                            Because I put the corresponding teleport addresses in the column next to it,
                            you can forget about this numbers.
                        </li>
                        <li>If you use savehouse 1, set byte 053D of block 25 to 0x60.<br/>Otherwise you can't leave the
                            house.
                        </li>
                        <li>
                            Savehouse 2 (desert airport) seems to act different than the other savehouses.<br/>
                            You will notice that when you try to go to other locations from this savehouse.
                        </li>
                    </ul>
                </div>
                <div className="section">
                    ...
                    <ul>
                        <li><b>ID</b> has no meaning in San Andreas, I gave the locations a number.</li>
                        <li><b>Map X</b> and <b>Map Y</b> are coordinates on <a href="?page=map">this map</a>.</li>
                    </ul>
                </div>
            </div>
        );
