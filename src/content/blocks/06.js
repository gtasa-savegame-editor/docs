...
class Block06 extends Component {
  render() {
    return (
      <div>
        <div>
            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="struct" colSpan={32}>
                    620 pickup structs
                  </td>
                </tr>
                <tr>
          ...
          <div className="section">
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    The amount of ammo for a weapon (should be 1 for night
                    vision and thermal gogs)
                  </li>
              ...
              <li>
                <b>X</b>, <b>Y</b> and <b>Z</b> are the coordinates multiplied
                by 8.
                <br />
                Pickups with a Z location of around 1000 (GTASA co-ord) will
                only appear in the interior map.
              </li>
              <li>
              ...
              <li>
                <b>Ref</b> is when the object was added to the pool, don't need
                to edit, just use any number greater that 0.
              </li>
              <li>
                <b>Type</b> and <b>Availability</b> define the presence and
                re-spawning characteristics of the pickup.
              </li>
            </ul>
          </div>
          <div className="section">
            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>Weapons</td>
                  <td className="center">0F / 00</td>
                  <td className="center">0F / 01</td>
                  <td />
                </tr>
                <tr>
                  <td>Weapons</td>
                  <td className="center">0F / 00</td>
                  <td className="center">0F / 05</td>
                  <td>Some weapons</td>
                </tr>
                <tr>
                  <td>Weapons</td>
                  <td className="center">02 / 00</td>
                  <td className="center">02 / 01</td>
                  <td>Some weapons</td>
                </tr>
                <tr>
                  <td>Oysters and horseshoes</td>
                  <td className="center">03 / 00</td>
                  <td className="center">00 / 09</td>
                  <td />
                </tr>
                <tr>
                  <td>Snapshots</td>
                ...
                <tr>
                  <td>Blue House</td>
                  <td className="center">11 / 20</td>
                  <td className="center">11 / 24</td>
                  <td />
                </tr>
                <tr>
                  <td>Green House</td>
                  <td className="center">12 / 10</td>
                  <td className="center">00 / 09</td>
                  <td />
                </tr>
                <tr>
            ...
            <ul>
              <li>
                Oysters, horseshoes and snapshots might disappear after they are
                collected.
              </li>
            </ul>
          </div>
            ...
            <table>
              <tbody>
                ...
                <tr>
                  ...
                  <td />
                  <td>Item pickup, respawn time 30s, respawn distance 15m</td>
                </tr>
                <tr>
                  <td className="center">03</td>
                  <td />
                  <td>Item Pickup, does not respawn.</td>
                </tr>
                <tr>
                  <td className="center">04</td>
                  <td className="center">Yes</td>
                  <td>Item picked-up, does not respawn.</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="center">Yes</td>
                  <td>Item has been picked-up, will not respawn.</td>
                </tr>
                <tr>
                  <td className="center">09</td>
                  <td />
                  <td>
                    Proximity bomb?, selfdestruct when player driving in
                    proximity 20m, explodes upon contact with vehs
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td />
                  <td>
                    Proximity bomb?, selfdestruct when player in proximity 40m,
                    explodes upon contact with vehs
                  </td>
                </tr>
                <tr>
                  ...
                  <td />
                  <td>
                    Item photo-op, fake pickup drops slowly down, real visible
                    when photographed.
                  </td>
                </tr>
                <tr>
                  ...
                  <td />
                  <td>
                    Vehicle pickup, drive thru it to make it disappear, does not
                    respawn.
                  </td>
                </tr>
                <tr>
                  ...
                  <td />
                  <td>Item pickup that respawns after time.</td>
                </tr>
                <tr>
                  <td className="center">10</td>
                  <td />
                  <td>Un-Pickable, (originally property)</td>
                </tr>
                <tr>
                  <td className="center">11</td>
                  <td />
                  <td>Shows cancel popup. (originally property)</td>
                </tr>
                <tr>
                  <td className="center">12</td>
                  <td />
                  <td>
                    Pay-Cash pickup, pay amount to make it disappear.
                    (originally property)
                  </td>
                </tr>
                <tr>
                  ...
                  <td />
                  <td>Get-Cash pickup, get amount to make it disappear.</td>
                </tr>
                <tr>
                  <td className="center">14</td>
                  <td />
                  <td>
                    Snapshot pickup, photograph it to make it disappear. Adds 1
                    snapshot collected.
                  </td>
                </tr>
                <tr>
