...
class Block08 extends Component {
  render() {
    return (
      <div>
        <div>
          <div className="section">
            <p>This block is about respawn locations.</p>
            <table>
              <tbody>
                <tr>
                ...
                <tr>
                  ...
                  <td className="struct" colSpan={19}>
                    Katie spawn struct
                  </td>
                  <td className="struct" colSpan={13}>
                    Barbara spawn struct
                  </td>
                </tr>
                <tr>
            ...
            <ul>
              <li>
                <b>X</b>, <b>Y</b> and <b>Z</b> are often all zero.
                <br />
          ...
          <div className="section">
            ...
            <ul>
              <li>
                <b>Heading</b> is in degrees.
                <br />0 = North, 64 = West, 128 = South, 192 = East (not
                checked)
              </li>
              <li>
                <b>Island</b> is 0, 1 or 2.
              </li>
            </ul>
          </div>
          <div className="section">
            ...
            <ul>
              <li>
                <b>?</b> is 1500 in a savegame of mine. It is often zero.
              </li>
