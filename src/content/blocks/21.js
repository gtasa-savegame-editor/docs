...
class Block21 extends Component {
  render() {
    return (
      <div>
        <div className="section">
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td className="bool">SF</td>
                <td className="bool">LV</td>
                <td className="unknown" />
                <td className="unknown" />
                <td className="unknown" />
                <td className="unknown" />
          ...
          <ul>
            <li>
              If <b>SF</b> is true, there are roadblocks between Los Santos and
              San Fierro.
            </li>
            <li>
              If <b>LV</b> is true, there are roadblocks between San Fierro and
              Las Venturas, and between Los Santos and Las Venturas.
            </li>
            <li>
              Use the first SF/LV pair for PCv1, the second for PCv2v3 and the
              third for PS2v1v2.
            </li>
          </ul>
        </div>
