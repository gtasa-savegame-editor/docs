...
class Block15 extends Component {
  render() {
    return (
      <div>
        <div className="section">
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td className="bool">IR</td>
                <td className="bool">FR</td>
                <td className="bool">Fi</td>
                <td className="bool">MH</td>
                <td className="bool">MA</td>
                <td className="bool">FB</td>
                <td className="bool">FW</td>
                <td className="bool">Dr</td>
                <td className="unknown" />
                <td className="unknown" />
                <td className="unknown" />
                <td className="unknown" />
          ...
          <ul>
            ...
            <li>
              <b>FB</b> = Free busted once
            </li>
            <li>
              <b>FW</b> = Free wasted once
            </li>
            <li>
              <b>Dr</b> = Enable driveby
            </li>
          </ul>
        </div>
      </div>
